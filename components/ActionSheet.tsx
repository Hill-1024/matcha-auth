        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
            ...
            >
                ...
                <div className="flex items-start gap-4 mb-6">
                    <div
                        className="flex items-center justify-center size-12 rounded-xl bg-primary/10 text-primary shrink-0">
                        {token.icon?.startsWith('http') ? (
                            <img src={token.icon} className="size-8 object-contain" alt={token.issuer} loading="lazy"/>
                        ) : token.icon?.includes(':') ? (
                            <Icon icon={token.icon} className="size-8 object-contain" />
                        ) : (
