...
export const AppLogoIcon = ({ className }: IconProps) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 8a1 1 0 0 1 1 1a1 1 0 0 1-1 1a1 1 0 0 1-1-1a1 1 0 0 1 1-1m9 3c0 5.55-3.84 10.74-9 12c-5.16-1.26-9-6.45-9-12V5l9-4l9 4zm-9-5a3 3 0 0 0-3 3c0 1.31.83 2.42 2 2.83V18h2v-2h2v-2h-2v-2.17c1.17-.41 2-1.52 2-2.83a3 3 0 0 0-3-3"/>
    </svg>
);

export const KeyIcon = ({ className }: IconProps) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12.65 10C11.83 7.67 9.61 6 7 6C3.69 6 1 8.69 1 12C1 15.31 3.69 18 7 18C9.61 18 11.83 16.33 12.65 14H17V10H12.65M7 14C5.9 14 5 13.1 5 12C5 10.9 5.9 10 7 10C8.1 10 9 10.9 9 12C9 13.1 8.1 14 7 14ZM21 10L12.65 18.35L14.65 20.35L16.65 18.35L18.65 20.35L21 18V10Z" />
    </svg>
);
...
export const SearchOffIcon = ({ className }: IconProps) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
        ...
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm4.59-13L15.17 8.41L12 5.24 8.83 8.41 7.41 7 10.59 3.83 12 5.24 13.41 3.83 16.59 7z" opacity="0"/>
        <path d="M2.81 2.81L1.39 4.22l2.27 2.27C2.61 8.07 2 9.71 2 11.5c0 5.25 4.25 9.5 9.5 9.5 1.79 0 3.43-.61 4.78-1.66l2.27 2.27 1.41-1.41L2.81 2.81zM11.5 19c-4.14 0-7.5-3.36-7.5-7.5 0-1.64.53-3.15 1.42-4.39l10.47 10.47c-1.24.89-2.75 1.42-4.39 1.42zM15.35 12.52l1.93 1.93c.14-.62.22-1.27.22-1.95 0-3.37-2.09-6.26-5-7.48V3.12c4.01 1.34 6.89 5.16 6.89 9.63 0 .62-.06 1.22-.16 1.81z" />
    </svg>
);
...
export const SpaIcon = ({ className }: IconProps) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M15.49 9.63c-.18-2.79-1.31-5.51-3.43-7.63-2.12 2.12-3.24 4.84-3.43 7.63C5.49 10.38 2 13.97 2 18.5 2 20.55 3.5 22 5.5 22c4.54 0 8.12-3.49 8.87-6.63.75 3.14 4.33 6.63 8.87 6.63 2 0 3.5-1.45 3.5-3.5 0-4.53-3.5-8.12-6.63-8.87H15.49zM5.5 20c-1.04 0-1.5-.72-1.5-1.5 0-3.39 2.14-6.32 5.16-7.81-.37 3.37-1.41 6.34-3.66 9.31zm9.66-9.31c3.02 1.49 5.16 4.42 5.16 7.81 0 .78-.46 1.5-1.5 1.5-2.25-2.97-3.29-5.94-3.66-9.31z" />
    </svg>
);
